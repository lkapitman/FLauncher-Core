...
public class PanelLogin extends Panel {
    ...
    public void init(PanelManager panelManager) {
        ...
        Label noAccount = new Label(Core.getRes().getString("login.noAccount"));
        Label registerHere = new Label(Core.getRes().getString("login.registerHere"));
        ...
        Label connectLabel = new Label(Core.getRes().getString("login.login.into.account"));
        ...
        Label usernameLabel = new Label(Core.getRes().getString("login.username"));
        ...
        Label passwordLabel = new Label(Core.getRes().getString("login.password"));
        ...
        Button connectionButton = new Button(Core.getRes().getString("login.login"));
            ...
            try {
                ...
                while(rst.next()) {
                    if (rst.getString(2).equals(usernameField.getText()) && rst.getString(3).equalsIgnoreCase(pass)) {
                        ...
                        this.panelManager.getTrayIcon().displayMessage(Constants.PROJECT_NAME,Core.getRes().getString("login.error.login"), TrayIcon.MessageType.ERROR);
                        return;
                    }
                }
