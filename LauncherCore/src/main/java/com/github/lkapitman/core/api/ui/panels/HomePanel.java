...
import com.github.lkapitman.core.api.runtime.MinecraftStarter;
...
public class HomePanel extends Panel implements DownloadListener {
    ...
    private void addTopPanel(GridPane pane) {
        ...
        resultButton.setOnMouseClicked(e-> {
            this.panelManager.getCore().downloadGame();

            MinecraftStarter starter = new MinecraftStarter(arguments, this.panelManager.getCore().getGameFolder(), PanelLogin.getPlayerName());
    ...
    private void showleftBar(GridPane pane) {
        ...
        Image logoImage = new Image(FileManager.class.getResource("/visual/valkyria.png").toExternalForm());
